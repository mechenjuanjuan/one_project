...
//        int x=1/0;
    ...
    public PageResult findPage(TbGoods goods, int pageNum, int pageSize) {
        ...
        if (goods != null) {
            if (goods.getSellerId() != null && goods.getSellerId().length() > 1) {
//                criteria.andSellerIdLike("%" + goods.getSellerId() + "%");
                criteria.andSellerIdEqualTo(goods.getSellerId());//条件登录的id名
            }
